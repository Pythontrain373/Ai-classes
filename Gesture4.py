...
Tip=H.HandLandmark
ids={"thumb":Tip.THUMB_TIP, "index":Tip.INDEX_FINGER_TIP, "middle":Tip.MIDDLE_FINGER_TIP, "ring":Tip.RING_FINGER_TIP, "pinky":Tip.PINKY_TIP}
...
MAIN, POP="Gesture-Controlled Photo App","Captures (ESC / Close to resume)"
...
while True:
    ...
    if res.multi_hand_landmarks:
        ...
        lm=hands.landmark;tips={k:(int(lm[v].x*w), int(lm[v].y*h)) for k,v in ids.items()}
